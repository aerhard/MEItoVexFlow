...
(this.render_options.max_slope-this.render_options.min_slope)/this.render_options.slope_iterations,g=Number.MAX_VALUE,h=0,k=0,n=this.render_options.min_slope;n<=this.render_options.max_slope;n+=c){for(var m=0,p=0,q=1;q<this.notes.length;++q){var D=this.notes[q],l=D.getStemX(),v=D.getStemExtents().topY;D.isRest()&&(v=-1===this.stem_direction?v+70:v+10);D=this.getSlopeY(l,a,b,n)+p;v*this.stem_direction<D*this.stem_direction?(v=Math.abs(v-D),p+=v*-this.stem_direction,m+=v*q):m+=(v-D)*this.stem_direction}q=
...
this.slope)+this.y_shift,q=g.getStemDirection(),l=this.render_options.beam_width,y=l-1,v=0;if(q===this.stem_direction)p=Math.abs(k-p)-c.HEIGHT-1;else{for(var K,r=e;r--;)if(K=this.notes[r],K.stem_direction===this.stem_direction){v=K.getBeamCount();break}1<v&&(v=Math.min(v,g.getGlyph().beam_count),y+=(v-1)*l*1.5);p=-Math.abs(k-p)-c.HEIGHT+.5+y}g.setStem(new Vex.Flow.Stem({x_begin:h-Vex.Flow.STEM_WIDTH/2,x_end:h,y_top:1===q?k:n,y_bottom:1===q?n:k,y_extend:m,stem_extension:p,stem_direction:q}))}}},getBeamLines:function(a){for(var b,
...
for(var h=b.getStemX(),k=this.render_options.beam_width*this.stem_direction,n=0;n<a.length;++n){for(var m=a[n],m=this.getBeamLines(m),p=0;p<m.length;++p){var q=m[p];if(!q.flipped){var l=q.start-(this.stem_direction==c.DOWN?Vex.Flow.STEM_WIDTH/2:0),y=this.getSlopeY(l,h,g,this.slope),q=q.end+(1==this.stem_direction?Vex.Flow.STEM_WIDTH/3:-Vex.Flow.STEM_WIDTH/3),v=this.getSlopeY(q,h,g,this.slope);this.context.beginPath();this.context.moveTo(l,y+this.y_shift);this.context.lineTo(l,y+k+this.y_shift);this.context.lineTo(q+
1,v+k+this.y_shift);this.context.lineTo(q+1,v+this.y_shift);this.context.closePath();this.context.fill()}}g+=1.5*k}k=this.render_options.beam_width*this.stem_direction*-1;g=b.getStemExtents().topY+.5*k;e.getStemExtents();h=b.getStemX();b=!1;for(n=0;n<a.length;++n){m=a[n];m=this.getBeamLines(m);for(p=0;p<m.length;++p)q=m[p],q.flipped&&(b=!0,l=q.start-(-1*this.stem_direction==c.DOWN?Vex.Flow.STEM_WIDTH/2:0),y=this.getSlopeY(l,h,g,this.slope),q=q.end+(1==-1*this.stem_direction?Vex.Flow.STEM_WIDTH/3:
-Vex.Flow.STEM_WIDTH/3),v=this.getSlopeY(q,h,g,this.slope),this.context.beginPath(),this.context.moveTo(l,y+this.y_shift),this.context.lineTo(l,y+k+this.y_shift),this.context.lineTo(q+1,v+k+this.y_shift),this.context.lineTo(q+1,v+this.y_shift),this.context.closePath(),this.context.fill());b&&(g+=1.5*k)}},preFormat:function(){return this},postFormat:function(){this.postFormatted||(this.calculateSlope(),this.applyStemExtensions(),this.postFormatted=!0)},draw:function(){if(!this.context)throw new Vex.RERR("NoCanvasContext",
...
c[0].x,m=g+c[0].y,p=d+c[1].x,c=f+c[1].y;b.moveTo(e,g);b.bezierCurveTo(n,m,p,c,d,f);b.bezierCurveTo(p,c+h,n,m+h,e,g)}else n=c[0].x,m=c[0].y,p=c[1].x,c=c[1].y,b.moveTo(e,g),b.bezierCurveTo(e+k+n,g+m*a.direction,d-k+p,f+c*a.direction,d,f),b.bezierCurveTo(d-k+p,f+(c+h)*a.direction,e+k+n,g+(m+h)*a.direction,e,g);b.stroke();b.closePath();b.fill()};Vex.Flow.Curve.prototype.draw=function(){var a=Vex.Flow.Curve;if(!this.context)throw new Vex.RERR("NoContext","No context to render tie.");var b=this.from,c=
this.to,d,f,e,g=d="baseY";f=this.render_options.position_end;this.render_options.position===a.Position.NEAR_TOP&&(g=d="topY");f==a.Position.NEAR_HEAD?g="baseY":f==a.Position.NEAR_TOP&&(g="topY");b?(a=b.getTieRightX(),e=b.getStemDirection(),f=b.getStemExtents()[d]):(a=c.getStave().getSlurStartX(),f=c.getStemExtents()[d]);c?(d=c.getTieLeftX(),e=c.getStemDirection(),b=c.getStemExtents()[g]):(d=b.getStave().getSlurEndX(),b=b.getStemExtents()[g]);this.renderCurve({first_x:a,last_x:d,first_y:f,last_y:b,
direction:e*(!0===this.render_options.invert?-1:1)});return!0};Vex.Flow.articulationCodes.articulations["a^b"]={code:"v16",width:8,shift_right:0,shift_up:6,shift_down:8,between_lines:!1};Vex.Flow.articulationCodes.articulations.avb={code:"v66",width:4,shift_right:0,shift_up:3,shift_down:-3,between_lines:!0};Vex.Flow.Font.glyphs.v66={x_min:-73.5,x_max:72.140625,ha:74,o:"m -36 -126 b 0 0 -17 -56 -1 0 b 70 -254 0 0 70 -249 l 72 -255 l 0 -255 l -73 -255 l -72 -254 b -36 -126 -72 -254 -55 -195 "};Vex.Flow.Font.glyphs.v16=
{x_min:-155.171875,x_max:153.8125,ha:157,o:"m -137 353 b -129 355 -134 353 -132 355 b -102 333 -118 355 -111 348 b -8 129 -63 273 -32 205 b 0 106 -4 116 -1 106 b 6 129 0 106 2 116 b 100 333 31 205 62 273 b 114 349 107 344 108 347 b 127 353 118 352 123 353 b 153 327 141 353 153 344 b 144 302 153 320 153 317 b 29 18 96 227 54 123 l 25 -4 b -1 -26 21 -19 13 -26 b -27 -4 -14 -26 -23 -19 l -31 18 b -145 302 -55 123 -98 227 b -155 327 -155 317 -155 320 b -137 353 -155 340 -148 349 "};Vex.Flow.durationToGlyph.duration_codes["1/2"].type.n=
{code_head:"noteheadDoubleWholeSquare"};Vex.Flow.durationToTicks.durations["1/4"]||(Vex.Flow.durationToTicks.durations["1/4"]=Vex.Flow.RESOLUTION/.25);Vex.Flow.durationToGlyph.duration_codes["1/4"]||(Vex.Flow.durationToGlyph.duration_codes["1/4"]={common:{head_width:22,stem:!1,stem_offset:0,flag:!1,stem_up_extension:-Vex.Flow.STEM_HEIGHT,stem_down_extension:-Vex.Flow.STEM_HEIGHT,gracenote_stem_up_extension:-Vex.Flow.STEM_HEIGHT,gracenote_stem_down_extension:-Vex.Flow.STEM_HEIGHT,tabnote_stem_up_extension:-Vex.Flow.STEM_HEIGHT,
...
"Can't draw stroke without a note and index.");var b=this.note.getModifierStartXY(this.position,this.index),d=this.note.getYs(),f=b.y,e=b.y,b=b.x-5,g=this.note.stave.options.spacing_between_lines_px,h=this.getModifierContext().getModifiers(this.note.getCategory()),k;for(k=0;k<h.length;k++)for(var d=h[k].getYs(),n=0;n<d.length;n++)if(this.note==h[k]||this.all_voices)f=Vex.Min(f,d[n]),e=Vex.Max(e,d[n]);var m,p,q,l,y;switch(this.type){case a.Type.BRUSH_DOWN:m="vc3";p=-3;q=f-g/2+10;e+=g/2;break;case a.Type.BRUSH_UP:m=
"v11";p=.5;q=e+g/2;f-=g/2;break;case a.Type.ROLL:f+=g/2;e=this.note instanceof Vex.Flow.StaveNote&&0!==(e-f)%2?e+.5*g:e+g;break;case a.Type.ROLL_DOWN:case a.Type.RASQUEDO_DOWN:m="vc3";p=-3;l=this.x_shift+p-2;this.note instanceof Vex.Flow.StaveNote?(f+=1.5*g,e=0!==(e-f)%2?e+.5*g:e+g,q=f-g,y=e+g+2):(f+=1.5*g,e+=g,q=f-.75*g,y=e+.25*g);break;case a.Type.ROLL_UP:case a.Type.RASQUEDO_UP:m="v52",p=-4,l=this.x_shift+p-1,this.note instanceof Vex.Flow.StaveNote?(f+=.5*g,0===(e-f)%2&&(e+=g/2),q=e+.5*g,y=f-1.25*
g):(f+=.25*g,e+=.5*g,q=e+.25*g,y=f-g)}if(this.type==a.Type.BRUSH_DOWN||this.type==a.Type.BRUSH_UP)this.context.fillRect(b+this.x_shift,f,1,e-f);else if(this.note instanceof Vex.Flow.StaveNote)for(k=f;k<=e;k+=g)Vex.Flow.renderGlyph(this.context,b+this.x_shift-4,k,this.render_options.font_scale,"va3");else{for(k=f;k<=e;k+=10)Vex.Flow.renderGlyph(this.context,b+this.x_shift-4,k,this.render_options.font_scale,"va3");this.type==Vex.Flow.Stroke.Type.RASQUEDO_DOWN&&(y=k+.25*g)}this.type!==a.Type.ROLL&&Vex.Flow.renderGlyph(this.context,
b+this.x_shift+p,q,this.render_options.font_scale,m);if(this.type==a.Type.RASQUEDO_DOWN||this.type==a.Type.RASQUEDO_UP)this.context.save(),this.context.setFont(this.font.family,this.font.size,this.font.weight),this.context.fillText("R",b+l,y),this.context.restore()}});return a}();Vex.Flow.Tremolo.prototype.draw=function(){if(!this.context)throw new Vex.RERR("NoContext","Can't draw Tremolo without a context.");if(!this.note||null==this.index)throw new Vex.RERR("NoAttachedNote","Can't draw Tremolo without a note and index.");
...
MeiLib.XMLID(c),b.alt_item=c):(a=a.getElementsByTagName("rdg")[0])?(b.alt_item_xml_id=MeiLib.XMLID(a),b.alt_item=a):b={};return b};MeiLib.MeiDoc.prototype.initSectionView=function(a){a=a||{};this.sectionview_score=this.rich_score.cloneNode(!0);this.sectionplane={};var b=this.sectionview_score.querySelectorAll("app, choice"),c,d=this.sectionview_score,f=this.sectionplane,e=this.ALTs,g=this.xmlDoc,h,k,n;k=0;for(n=b.length;k<n;k++){h=b[k];var m=MeiLib.XMLID(h),p=a[m];if(p){c=p.xmlID;var q=C(d).find(p.tagname+
'[xml\\:id="'+c+'"]')[0];if(!q)throw new MeiLib.RuntimeError("MeiLib.MeiDoc.prototype.initSectionView():E01","Cannot find <lem>, <rdg>, <sic>, or <corr> with @xml:id '"+c+"'.");}else if(p=this.ALTs[m].getDefaultItem())c=p.xmlID,q=p.elem;var p=h.parentNode,l=g.createProcessingInstruction("MEI2VF",'rdgStart="'+m+'"');p.insertBefore(l,h);if(q){var l=q.childNodes,y;for(y=0;y<l.length;++y)p.insertBefore(l.item(y).cloneNode(!0),h)}l=g.createProcessingInstruction("MEI2VF",'rdgEnd="'+m+'"');p.insertBefore(l,
...
this.altgroups[b];if(h)for(g=0;g<h.length;g++){c=h[g];var k=[],n,m;n=0;for(m=e.length;n<m;n++)k.push(d(f[c].altitems,e[n]));this.replaceAltInstance({appXmlID:c,replaceWith:k})}else this.replaceAltInstance({appXmlID:b,replaceWith:e})}};MeiLib.MeiDoc.prototype.replaceAltInstance=function(a){var b=function(a,b){var c;for(c=0;c<b.length;++c)a.push(b.item(c));return a},c=a.appXmlID,d=C(this.sectionview_score).find("[xml\\:id="+this.ALTs[c].parentID+"]")[0];if("undefined"!==typeof d){var f=d.childNodes,
e=a.replaceWith,g=[],h=this.rich_score;if(e){var k;for(k=0;k<e.length;++k)var n=e[k],m=n.xmlID,n=C(h).find(n.tagname+'[xml\\:id="'+m+'"]')[0],g=b(g,n.childNodes)}var e=function(a,b){a=a.replace("'",'"');b=b.replace("'",'"');return a===b},n=h=!1,p=null;k=0;for(b=f.length;k<b;k++)m=f[k],7===m.nodeType?"MEI2VF"===m.nodeName&&e(m.nodeValue,'rdgStart="'+c+'"')?n=h=!0:"MEI2VF"===m.nodeName&&e(m.nodeValue,'rdgEnd="'+c+'"')&&(h=!1,p=m):h&&(d.removeChild(m),k--,b--);if(!n)throw"processing instruction not found";
...
startTie:function(a,b){var c=new F(a,null);c.setParams({linkCond:b});this.allModels.push(c)},terminateTie:function(a,b){var c,d,f,e,g;g=this.getModels();c=function(a,b){return a&&b&&a.vexPitch===b.vexPitch&&a.stave_n===b.stave_n};d=!1;for(f=0;!d&&f<g.length;++f)e=g[f],!e.getLastId()&&c(e.params.linkCond,b)&&(d=!0,e.setLastId(a));d||this.addModel(new F(null,a))},createVexFromInfos:function(a){var b,c,d,f,e;d=0;for(f=this.allModels.length;d<f;d++){e=this.allModels[d];var g,h;b=a[e.getFirstId()]||{};
c=a[e.getLastId()]||{};if(!b.vexNote&&!c.vexNote){var k;a="";for(k in e.params)a+=k+'="'+e.params[k]+'" ';console.log(e);w.warn("Tie could not be processed","No tie start or tie end could be found. Tie parameters: "+a+". Skipping tie.");return!0}if(!e.params.curvedir){var l=b.layerDir||c.layerDir;l?e.params.curvedir=-1===l?"below":1===l?"above":u:(b.vexNote?(g=b.vexNote.keys.length,h=b.index):c.vexNote&&(g=c.vexNote.keys.length,h=c.index),1<g&&(1===h.length?e.params.curvedir=h[0]+1>g/2?"above":"below":
e.params.multiCurves=h.map(function(a){return a+1>g/2?"above":"below"})))}b.system!==u&&c.system!==u&&b.system!==c.system?(this.createSingleTie(b,{},e.params),e.params.curvedir||(e.params.curvedir=-1===b.vexNote.getStemDirection()?"above":"below"),this.createSingleTie({},c,e.params)):(l=b.vexNote||c.vexNote,e.params.curvedir||(e.params.curvedir=-1===l.getStemDirection()?"above":"below"),this.createSingleTie(b,c,e.params))}return this},createSingleTie:function(a,b,c){var d=this;if(c.multiCurves)c.multiCurves.forEach(function(c,
f){var h=new l.StaveTie({first_note:a.vexNote,last_note:b.vexNote,first_indices:a.index?[a.index[f]]:a.vexNote?[0]:[b.index[f]],last_indices:b.index?[b.index[f]]:b.vexNote?[0]:[a.index[f]]});h.setDir("above"===c?-1:1);a.vexNote&&!0===a.vexNote.grace&&(h.render_options.first_x_shift=-5);d.allVexObjects.push(h)});else{var f=new l.StaveTie({first_note:a.vexNote,last_note:b.vexNote,first_indices:a.index||(a.vexNote?[0]:b.index),last_indices:b.index||(b.vexNote?[0]:a.index)});c.curvedir&&f.setDir("above"===
c.curvedir?-1:1);a.vexNote&&!0===a.vexNote.grace&&(f.render_options.first_x_shift=-5);d.allVexObjects.push(f)}}});var W=function(a,b){this.init(a,b)};Vex.Inherit(W,A,{init:function(a,b){W.superclass.init.call(this,a,b)},validateAtts:function(){},startSlur:function(a,b){var c=new F(a,null);c.setParams({linkCond:b});this.allModels.push(c)},terminateSlur:function(a,b){var c,d,f,e,g=this.getModels();c=function(a,b){return a.nesting_level===b.nesting_level};d=!1;for(f=0;f<g.length;++f)if((e=g[f])&&!e.getLastId()&&
...
return!0}var q,r;b.vexNote&&(q=b.vexNote.getStemDirection());c.vexNote&&(r=c.vexNote.getStemDirection());n=b.layerDir||c.layerDir;e=q||r;(g=h.bezier)?(m.cps=this.bezierStringToCps(g),m.custom_cps=!0,k=0>m.cps[0].y?1:-1):(k||(k=n?n:-1*e),m.invert=!(-1===k&&1===r||1===k&&-1===r));g=-5*parseFloat(h.startvo);h=-5*parseFloat(h.endvo);m.y_shift_start=g;m.y_shift_end=h;b.vexNote&&c.vexNote&&b.vexNote.hasStem()&&c.vexNote.hasStem()?q!==r&&q&&r?e===k?(m.position=l.Curve.Position.NEAR_TOP,m.position_end=l.Curve.Position.NEAR_HEAD):
...
this.tickables[c];if(!d.getStave())throw new Vex.RuntimeError("MissingStave","The voice cannot draw tickables without staves.");d.setStave(d.getStave());0===c&&(b=d.getBoundingBox());if(0<c&&b){var f=d.getBoundingBox();f&&b.mergeWith(f)}d.setContext(a);d.draw()}this.boundingBox=b}};var B=function(a){a&&this.initConfig(a);return this};B.prototype={defaults:{pageWidth:null,pageTopMar:60,pageBottomMar:80,pageLeftMar:20,pageRightMar:20,defaultSpacingInMeasure:180,systemSpacing:90,staveSpacing:60,autoStaveConnectorLine:!0,
...
null);"rptstart"===e.rightBarline&&(e.rightBarline=null,b.leftBarlineElement=a);var g=[],h=[],k=[],l=[],m=[],p=[],q=[],r=[],t=[],v=[],x=[],u,z;f=a.childNodes;u=0;for(z=f.length;u<z;u++)switch(f[u].localName){case null:break;case "staff":g.push(f[u]);break;case "dir":k.push(f[u]);break;case "harm":k.push(f[u]);break;case "tie":m.push(f[u]);break;case "slur":l.push(f[u]);break;case "hairpin":p.push(f[u]);break;case "tempo":q.push(f[u]);break;case "dynam":r.push(f[u]);break;case "arpeg":h.push(f[u]);
break;case "fermata":t.push(f[u]);break;case "mordent":case "turn":case "trill":x.push(f[u]);break;case "reh":v.push(f[u]);break;case "beamSpan":this.beams.addSpanElements(f[u]);break;case "tupletSpan":this.tuplets.addSpanElements(f[u]);break;default:w.info("Not supported","<"+f[u].localName+"> is not supported as child of <measure>.")}f=this.initializeStavesInMeasure(d,g,e,c,b);var A=this.allVexMeasureStaves.push(f)-1,B=new qa,C=new ga(this.notes_by_id,this.currentSystem_n);u=0;for(z=g.length;u<
z;u++)this.processStaveEvents(f,g[u],A,B,C);0!==C.clefCheckQueue.length&&this.processClefCheckQueue(C);this.dynamics.createInfos(r,a);this.arpeggios.createInfos(h,a);this.directives.createInfos(k,a);this.fermatas.createInfos(t,a);this.ornaments.createInfos(x,a);this.ties.createInfos(m,a,A,this.systemInfo);this.slurs.createInfos(l,a,A,this.systemInfo);this.hairpins.createInfos(p,a,A,this.systemInfo);c=new ka({system:d,element:a,staves:f,voices:B,startConnectorCfg:c?{labelMode:this.cfg.labelMode,models:this.systemInfo.startConnectorInfos,
...
d=0;for(f=a.length;d<f;d+=1)if(c=a[d],1===c.length)b.push({letter:c,nesting_level:0});else if(2===c.length){e=+c[1];if(!e)throw new x("badly formed slur attribute");b.push({letter:c[0],nesting_level:e})}else throw new x("badly formed slur attribute");return b},processSyllables:function(a,b,c){var d,f,e;f=b.getElementsByTagName("syl");b.hasAttribute("syl")&&(e=new z(b.getAttribute("syl").replace(/\s+/g," "),b,this.cfg.lyricsFont),a.addAnnotation(0,e),this.page.getSystems()[this.currentSystem_n].verses.addSyllable(e,
b,c));b=0;for(d=f.length;b<d;b++)e=new z(r.getNormalizedText(f[b]),f[b],this.cfg.lyricsFont),a.addAnnotation(0,e),this.page.getSystems()[this.currentSystem_n].verses.addSyllable(e,f[b],c)}};window.MeiLib=MeiLib;window.MEI2VF={setLogging:function(a){w.setLevel.call(w,a)},setLoggerAppender:function(a){w.setAppender.call(w,a)},Converter:{initConfig:function(a){B.prototype.initConfig(a)},reset:function(){B.prototype.reset()},process:function(a){B.prototype.process(a)},format:function(a){B.prototype.format(a)},
draw:function(a){B.prototype.draw(a)},getAllVexMeasureStaffs:function(){return B.prototype.getAllVexMeasureStaves()},getStaffArea:function(){return B.prototype.getStaveArea()}},rendered_measures:null,render_notation:function(a,b,c,d,f,e,g){e=e||{};b=(new l.Renderer(b,f||l.Renderer.Backends.CANVAS)).getContext();e.pageWidth=c;this.Converter.initConfig(e);this.Converter.reset();this.Converter.process(a[0]||a);this.Converter.format(b);this.calculatedHeight=d?null:B.prototype.pageInfo.getCalculatedHeight();
B.prototype.pageInfo.hasCalculatedWidth()?this.calculatedWidth=B.prototype.pageInfo.getCalculatedWidth():this.calculatedWidth=null;+f===l.Renderer.Backends.RAPHAEL&&b.paper.setSize(this.calculatedWidth||c,this.calculatedHeight||d);g&&g(this.calculatedHeight,this.calculatedWidth);this.Converter.draw(b);this.rendered_measures=this.Converter.getAllVexMeasureStaffs()}}})(jQuery,Vex.Flow);
