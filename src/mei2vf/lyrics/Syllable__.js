...
], function (VF, Vex, Util, Annotation) {

  var Syllable = function(element, font){

    var annot = new VF.Annotation(Util.getText(element));
    annot.setFont(font.family, font.size, font.weight);
    annot.setVerticalJustification(VF.Annotation.VerticalJustify.BOTTOM);
    annot.setMeiElement(element);

    annot.hasFixedTextLine = true;
...
//
//  Vex.Inherit(Syllable, VF.Annotation, {
