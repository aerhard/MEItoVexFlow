...
var MEI2VF = ( function(m2v, MeiLib, VF, $, undefined) {
  ...
  m2v.Converter.prototype = {
    ...
    processNote : function(element, staff, staff_n, layerDir) {
      ...
      try {
        ...
        try {
          ...
          throw new m2v.RUNTIME_ERROR('BadArguments', 'A problem occurred processing the dots of ' + m2v.Util.serializeElement(element));
        }
        ...
        throw new m2v.RUNTIME_ERROR('BadArguments', 'A problem occurred processing ' + m2v.Util.serializeElement(element) + '\nORIGINAL ERROR MESSAGE: ' + e1.toString());
      }
    },
    ...
    translateDuration : function(mei_dur) {
      ...
      if (alias[mei_dur]) {
        m2v.L('info', 'Not supported', 'Duration "' + mei_dur + '" is not supported. Using "' + alias[mei_dur] + '" instead.');
